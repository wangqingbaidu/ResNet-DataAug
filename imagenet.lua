...
function ImagenetDataset:preprocessRandCrop()
   if self.split == 'train' then
      return t.Compose{
         t.RandomSizedCrop(224),
         t.Lighting(0.1, pca.eigval, pca.eigvec),
...
function ImagenetDataset:preprocessHFlip()
   if self.split == 'train' then
      return t.Compose{
         t.RandomSizedCrop(224),
         t.HorizontalFlip(1),
...
function ImagenetDataset:preprocessVFlip()
   if self.split == 'train' then
      return t.Compose{
         t.RandomSizedCrop(224),
         t.VerticalFlip(1),
...
function ImagenetDataset:preprocessColorJitter(b, c, s)
   b = b or math.random()
   c = c or math.random()
   s = s or math.random()
   if self.split == 'train' then
...
function ImagenetDataset:preprocessRotation(deg)
   deg =deg or math.random(1,360)
   if self.split == 'train' then
      return t.Compose{
         t.RandomSizedCrop(224),
         t.Rotation(deg),
...
function ImagenetDataset:preprocessScale(size)
   size = size or math.random(224,256)
   if self.split == 'train' then
      return t.Compose{
         t.Scale(size),
         t.RandomSizedCrop(224),
