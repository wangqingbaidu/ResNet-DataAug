...
function M.parse(arg)
   ...
   cmd:option('-crop_num',          1, 'number of randcrop')
   cmd:option('-hflip_num',         1, 'number of hflip')
   cmd:option('-vflip_num',         1, 'number of vflip')
   cmd:option('-color_jitter_num',  1, 'number of color jitter')
   cmd:option('-rotation_num',      1, 'number of rotarion')
   cmd:option('-scale_num',         1, 'number of scale')
